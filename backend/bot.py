...
print("\n")
print(bot.query("What did Xingyu do in the arduino project?"))
print("\n")
print(bot.query("What are the prerequisites for CS 589?"))
print("\n")
print(bot.query("What is the best ice cream flavor?"))
print("\n")
